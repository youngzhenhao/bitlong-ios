...
/** 图片滚动中回调 */
- (void)cycleScrollView:(SDCycleScrollView *)cycleScrollView offset:(CGFloat)offset currentIndx:(NSInteger)currentId nextIndex:(NSInteger)nextId isTurnFirst:(BOOL)isTurnFirst;
...
/** block方式监听滚动 */
@property (nonatomic, copy) void (^itemDidScrollOperationBlock)(NSInteger currentIndex,UIScrollView*scroll,UICollectionView*colectview);
