...
@property (nonatomic, assign) CGFloat titleImageDistance;    //titleLabel和ImageView的边距，默认5

@property (nonatomic, assign, getter=isImageZoomEnabled) BOOL imageZoomEnabled;

@property (nonatomic, assign) CGFloat imageZoomScale;

@property (nonatomic, assign) CGFloat imageBordeWidth;//image边框宽度
@property (nonatomic, strong) UIColor * imageBordeColor;//image边框颜色
